...
class ViewPatientsHsHead extends StatefulWidget {
  const ViewPatientsHsHead({super.key});

  @override
  State<ViewPatientsHsHead> createState() => _ViewPatientsHsHeadState();
}

class _ViewPatientsHsHeadState extends State<ViewPatientsHsHead> {
