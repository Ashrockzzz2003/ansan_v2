...
class Questionnaire15cHsHeadScreen extends StatefulWidget {
  const Questionnaire15cHsHeadScreen({super.key, required this.patientId});

  final String patientId;

  @override
  State<Questionnaire15cHsHeadScreen> createState() => _Questionnaire15cHsHeadScreenState();
}

class _Questionnaire15cHsHeadScreenState extends State<Questionnaire15cHsHeadScreen> {
  String? secretToken = "";
  String? patientToken = "";
