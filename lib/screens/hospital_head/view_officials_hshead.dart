...
class ViewOfficialsHsHeadScreen extends StatefulWidget {
  const ViewOfficialsHsHeadScreen({super.key});

  @override
  State<ViewOfficialsHsHeadScreen> createState() =>
      _ViewOfficialsHsHeadScreenState();
}

class _ViewOfficialsHsHeadScreenState extends State<ViewOfficialsHsHeadScreen> {
