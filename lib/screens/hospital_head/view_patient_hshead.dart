...
import 'package:eperimetry_vtwo/screens/hospital_head/questionnaire_1_hshead.dart';
import 'package:eperimetry_vtwo/screens/hospital_head/questionnaire_2_hshead.dart';
...
class ViewPatientHsHead extends StatefulWidget {
  const ViewPatientHsHead({super.key, required this.patientId});

  final String patientId;

  @override
  State<ViewPatientHsHead> createState() => _ViewPatientHsHeadState();
}

class _ViewPatientHsHeadState extends State<ViewPatientHsHead> {
  bool isLoading = true;
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.of(context)
                                      ...
                                      builder: (context) {
                                        return QuestionnaireFull15bHsHeadScreen(
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.of(context)
                                        .push(CupertinoPageRoute(
                                      builder: (context) {
                                        return Questionnaire15cHsHeadScreen(
                                          patientId: patientData["patientId"]
                                              .toString(),
                                        );
                                      },
