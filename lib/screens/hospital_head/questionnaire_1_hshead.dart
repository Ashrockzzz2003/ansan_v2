...
class QuestionnaireFull15bHsHeadScreen extends StatefulWidget {
  const QuestionnaireFull15bHsHeadScreen({super.key, required this.patientId});

  final String patientId;

  @override
  State<QuestionnaireFull15bHsHeadScreen> createState() =>
      _QuestionnaireFull15bHsHeadScreenState();
}

class _QuestionnaireFull15bHsHeadScreenState
    extends State<QuestionnaireFull15bHsHeadScreen> {
  String? secretToken = "";
  String? patientToken = "";
