...
class NewPatientHsHeadScreen extends StatefulWidget {
  const NewPatientHsHeadScreen({super.key});

  @override
  State<NewPatientHsHeadScreen> createState() => _NewPatientHsHeadScreenState();
}

class _NewPatientHsHeadScreenState extends State<NewPatientHsHeadScreen> {
  /*
  {
    "phoneNumber" : null,
    "userName" : "Mithun",
