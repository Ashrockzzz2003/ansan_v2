...
import 'package:eperimetry_vtwo/screens/user/family_member_survey_screen.dart';
                      ...
                      return ExpansionTile(
                        ...
                        subtitle: Align(
                          ...
                          child: Chip(
                            ...
                            label: Text(
                              familyMembers[index]["surveyLevel"] == "0"
                                  ? "Questionnaire Pending"
                                  : "Questionnaire Done",
                              style: GoogleFonts.raleway(
                                fontWeight: FontWeight.w500,
                                color: familyMembers[index]["surveyLevel"] ==
                                        "0"
                        ...
                        children: [
                                        ...
                                        TextField(
                                          controller: TextEditingController(
                                              text: familyMembers[index]
                                                  ...
                                                  : "Female"),
                                          decoration: InputDecoration(
                                            prefixIcon: familyMembers[index]
                                                        ["gender"] ==
                                                    "M"
                          ...
                          if (familyMembers[index]["surveyLevel"] == "0") ...[
                            ListTile(
                              onTap: () {
                                Navigator.of(context).push(CupertinoPageRoute(
                                  builder: (context) {
                                    return FamilyMemberSurveyScreen(
