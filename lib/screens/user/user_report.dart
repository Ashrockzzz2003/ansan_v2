...
class ViewReportUserScreen extends StatefulWidget {
  const ViewReportUserScreen({
    super.key,
  ...
  @override
  State<ViewReportUserScreen> createState() => _ViewReportUserScreenState();
}

class _ViewReportUserScreenState extends State<ViewReportUserScreen> {
