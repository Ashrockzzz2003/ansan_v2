...
import 'package:eperimetry_vtwo/screens/user/family_member/family_member_report.dart';
...
class _FamilyMemberReportsScreenState
    extends State<FamilyMemberReportsScreen> {
                            ...
                            ListTile(
                              onTap: () {
                                Navigator.of(context).push(
                                    CupertinoPageRoute(
                                        builder: (context) {
                                          return ViewReportFamilyMemberScreen(
