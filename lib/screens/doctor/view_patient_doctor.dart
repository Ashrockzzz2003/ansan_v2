...
class ViewPatientDoctor extends StatefulWidget {
  const ViewPatientDoctor({super.key, required this.patientId});

  final String patientId;

  @override
  State<ViewPatientDoctor> createState() => _ViewPatientDoctorState();
}

class _ViewPatientDoctorState extends State<ViewPatientDoctor> {
  bool isLoading = true;
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.of(context)
                                        .push(CupertinoPageRoute(
                                      builder: (context) {
                                        return PatientReportsDoctorScreen(
                                          patientId: patientData["patientId"]
                                              .toString(),
                                          patientEmail: patientData["userEmail"].toString(),
                                        );
                                      },
                                    ));
                                  },
