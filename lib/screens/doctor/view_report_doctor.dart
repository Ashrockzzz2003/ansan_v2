...
class ViewReportDoctorScreen extends StatefulWidget {
  const ViewReportDoctorScreen(
      {super.key,
  ...
  @override
  State<ViewReportDoctorScreen> createState() => _ViewReportDoctorScreenState();
}

class _ViewReportDoctorScreenState extends State<ViewReportDoctorScreen> {
    ...
    try {
      ...
      final response = await dio.post(
        ...
        data: {
          ...
          "patient_token": patientToken.toString(),
          "description": _doctorComment.text.toString(),
        },
      );
