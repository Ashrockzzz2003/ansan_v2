...
class NewPatientFrontlineWorkerScreen extends StatefulWidget {
  const NewPatientFrontlineWorkerScreen({super.key});

  @override
  State<NewPatientFrontlineWorkerScreen> createState() => _NewPatientFrontlineWorkerScreenState();
}

class _NewPatientFrontlineWorkerScreenState extends State<NewPatientFrontlineWorkerScreen> {
  /*
  {
    "phoneNumber" : null,
    "userName" : "Mithun",
