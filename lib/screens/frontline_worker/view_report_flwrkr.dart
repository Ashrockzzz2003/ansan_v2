...
class ViewReportFrontlineWorkerScreen extends StatefulWidget {
  const ViewReportFrontlineWorkerScreen({
    super.key,
  ...
  @override
  State<ViewReportFrontlineWorkerScreen> createState() =>
      _ViewReportFrontlineWorkerScreenState();
}

class _ViewReportFrontlineWorkerScreenState
    extends State<ViewReportFrontlineWorkerScreen> {
