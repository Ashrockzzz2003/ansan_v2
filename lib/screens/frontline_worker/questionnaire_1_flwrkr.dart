...
class QuestionnaireFull15bFrontlineWorkerScreen extends StatefulWidget {
  const QuestionnaireFull15bFrontlineWorkerScreen(
      {super.key, required this.patientId});

  final String patientId;

  @override
  State<QuestionnaireFull15bFrontlineWorkerScreen> createState() =>
      _QuestionnaireFull15bFrontlineWorkerScreenState();
}

class _QuestionnaireFull15bFrontlineWorkerScreenState
    extends State<QuestionnaireFull15bFrontlineWorkerScreen> {
  String? secretToken = "";
  String? patientToken = "";
