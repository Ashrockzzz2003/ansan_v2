...
class Questionnaire15cFrontlineWorkerScreen extends StatefulWidget {
  const Questionnaire15cFrontlineWorkerScreen(
      {super.key, required this.patientId});

  final String patientId;

  @override
  State<Questionnaire15cFrontlineWorkerScreen> createState() =>
      _Questionnaire15cFrontlineWorkerScreenState();
}

class _Questionnaire15cFrontlineWorkerScreenState
    extends State<Questionnaire15cFrontlineWorkerScreen> {
  String? secretToken = "";
  String? patientToken = "";
