...
class NewReportFrontlineWorkerScreen extends StatefulWidget {
  const NewReportFrontlineWorkerScreen(
  ...
  @override
  State<NewReportFrontlineWorkerScreen> createState() =>
      _NewReportFrontlineWorkerScreenState();
}

class _NewReportFrontlineWorkerScreenState
    extends State<NewReportFrontlineWorkerScreen> {
  String? secretToken = "";
  String? patientToken = "";
