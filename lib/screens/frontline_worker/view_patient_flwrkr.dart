...
import 'package:eperimetry_vtwo/screens/frontline_worker/patient_reports_flwrkr.dart';
import 'package:eperimetry_vtwo/screens/frontline_worker/questionnaire_1_flwrkr.dart';
import 'package:eperimetry_vtwo/screens/frontline_worker/questionnaire_2_flwrkr.dart';
...
class ViewPatientFrontlineWorkerScreen extends StatefulWidget {
  const ViewPatientFrontlineWorkerScreen({super.key, required this.patientId});

  final String patientId;

  @override
  State<ViewPatientFrontlineWorkerScreen> createState() =>
      _ViewPatientFrontlineWorkerScreenState();
}

class _ViewPatientFrontlineWorkerScreenState
    extends State<ViewPatientFrontlineWorkerScreen> {
  bool isLoading = true;

  Map<String, dynamic> patientData = {"statusCode": "400"};
  ...
  Widget build(BuildContext context) {
    return isLoading ||
            (patientData["statusCode"] != null &&
                patientData["statusCode"] == "400")
        ? const LoadingScreen()
        : Scaffold(
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.of(context)
                                      ...
                                      builder: (context) {
                                        return QuestionnaireFull15bFrontlineWorkerScreen(
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.of(context)
                                        .push(CupertinoPageRoute(
                                      builder: (context) {
                                        return Questionnaire15cFrontlineWorkerScreen(
                                          patientId: patientData["patientId"]
                                              .toString(),
                                        );
                                      },
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.of(context)
                                        .push(CupertinoPageRoute(
                                      builder: (context) {
                                        return PatientReportsFrontlineWorkerScreen(
                                          patientId: patientData["patientId"]
                                              .toString(),
